function [ cells, exclude ] = calc_dFF( cells, stackInfo, logfileTimes, corrFactor )
% % calc_dFF %
...
%   roiData:        struct w/ fields: cellf, neuropilf; generated by calcCellF.m
...
for i = 1:nROIs
    ...
    for j = 1:length(F)
        ...
        baseline_NP(j) = prctile(neuropilf(idx1:idx2),5);   %For neuropil subtraction F0 for ROI must exceed that of neuropil
    end
