...
% Rule ID from cue code  
idx.sound = find(ismember(trialData.cue,[STIM.sound_UPSWEEP,STIM.sound_DNSWEEP])); 
...
% Last trial pre-switch for each block, by rule
lastTrial.sound = idx.sound(diff([idx.sound; nTrials+1])~=1);   
