...
% expData(i).strain   = 'SST-cre'; %Mouse strain(s)
% expData(i).virus    = 'AAV1-flex-GCaMP6s'; %Viral injection
...
% expData(i).npCorrFactor = 0.5;
% % i = i+1;
% % expData(i).sub_dir = '171024 M47 RuleSwitching'; %SAME FOV AS 170928 M47 RuleSwitching
...
% expData(i).strain   = 'VIP::GCaMP6f'; %Mouse strain(s)
% expData(i).virus    = 'none'; %Viral injection
...
% expData(i).strain   = 'PV-cre'; %Mouse strain(s)
% expData(i).virus    = 'AAV1-flex-GCaMP6s'; %Viral injection
...
% expData(i).cellType = 'PV'; %Cell-type label
% expData(i).strain   = 'PV-cre'; %Mouse strain(s)
% expData(i).virus    = 'AAV1-flex-GCaMP6s'; %Viral injectionexpData(i).npCorrFactor = 0.3;
% i = i+1;
...
% expData(i).cellType = 'PV'; %Cell-type label
% expData(i).strain   = 'PV::GCaMP6f'; %Mouse strain(s)
% expData(i).virus    = 'none'; %Viral injection
% expData(i).npCorrFactor = 0.3;
% i = i+1;
...
% expData(i).strain   = 'PV-cre'; %Mouse strain(s)
% expData(i).virus    = 'AAV1-CamKII-GCaMP6f'; %Viral injection
% expData(i).npCorrFactor = 0.3;
% i = i+1;
